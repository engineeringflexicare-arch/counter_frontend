...
export default function SupervisorLineUpdatePanel() {
  ...
  const filteredLines = Object.entries(lines).filter(([, line]) => !line.floor || line.floor === floor);
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input type="number" value={hourlyTarget} onChange={(e) => setHourlyTarget(e.target.value)} className="w-full border rounded-2xl px-4 py-3" />
            </div>
          </div>
